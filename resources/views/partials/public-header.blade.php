...
.public-brand-fallback{display:grid;place-items:center;border-radius:10px;color:var(--ff-cyan);border:1px solid rgba(87,230,255,.22);background:rgba(57,230,166,.035);box-shadow:0 0 20px rgba(87,230,255,.08)}
.public-brand-name{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-size:16px;line-height:1.2;font-weight:800;letter-spacing:.01em}.public-brand-name{background:linear-gradient(270deg,#fff 0%,#39E6A6 100%);-webkit-background-clip:text;background-clip:text;color:transparent!important}
.public-header-tools{display:flex;align-items:center;justify-content:flex-end;gap:7px;min-width:0;flex:0 0 auto}.public-header-socials{display:flex;align-items:center;gap:5px}.public-header-social{display:inline-flex;align-items:center;justify-content:center;width:34px;height:34px;border-radius:9px;color:var(--ff-muted)!important;background:rgba(87,230,255,.025);border:1px solid rgba(57,230,166,.14);text-decoration:none!important;transition:color .18s ease,background .18s ease,border-color .18s ease,transform .18s ease}.public-header-social:hover{color:var(--social-color)!important;background:color-mix(in srgb,var(--social-color) 9%,transparent);border-color:color-mix(in srgb,var(--social-color) 30%,transparent);transform:translateY(-1px)}.public-header-social i{font-size:13px}.public-header-divider{width:1px;height:34px;background:linear-gradient(to bottom,transparent,rgba(87,230,255,.4),transparent);margin:0 4px}
...
.public-menu{width:100%;display:flex;align-items:center;justify-content:center;gap:4px;min-width:0;white-space:nowrap}.public-menu a,.public-menu a:visited,.public-menu-dropdown-toggle{display:inline-flex;align-items:center;justify-content:center;min-height:34px;padding:6px 11px;border-radius:8px;color:var(--ff-muted)!important;font-size:12px;line-height:1.15;font-weight:650;text-decoration:none!important;white-space:nowrap;background:transparent;border:0}.public-menu a:hover,.public-menu a:active,.public-menu a:focus,.public-menu-dropdown-toggle:hover,.public-menu-dropdown-toggle:focus,.public-menu-dropdown-toggle[aria-expanded=true]{color:var(--ff-text)!important;background:linear-gradient(135deg,rgba(57,230,166,.10),rgba(57,230,166,.045));outline:none}.public-menu a[aria-current=page],.public-menu-dropdown-toggle[aria-current=page]{color:var(--ff-cyan)!important;background:rgba(57,230,166,.075);box-shadow:inset 0 -1px 0 rgba(57,230,166,.78)}
...
.public-menu-toggle{display:none;width:42px;height:42px;border:1px solid rgba(87,230,255,.22);border-radius:11px;background:linear-gradient(135deg,rgba(87,230,255,.07),rgba(57,230,166,.035));color:var(--ff-text);align-items:center;justify-content:center;cursor:pointer;box-shadow:0 0 18px rgba(87,230,255,.05);transition:.18s ease}.public-menu-toggle:hover,.public-menu-toggle:focus-visible{border-color:rgba(87,230,255,.45);box-shadow:0 0 22px rgba(57,230,166,.14);outline:none}.mobile-portal-separator,.mobile-menu-portal{display:none!important}
