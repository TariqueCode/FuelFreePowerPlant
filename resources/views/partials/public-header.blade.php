...
.public-header{isolation:isolate}.public-header .public-shell{position:relative}.public-header-top{padding:7px 0}.public-brand{position:relative;padding:5px 7px 5px 5px;border:1px solid transparent;border-radius:14px;transition:background .2s ease,border-color .2s ease,box-shadow .2s ease}.public-brand:hover{background:transparent;border-color:transparent;box-shadow:none}.public-brand img,.public-brand-fallback{width:46px;height:46px;flex-basis:46px;border-radius:12px}.public-brand-name{font-size:clamp(15px,1.1vw,17px);letter-spacing:.005em;text-shadow:0 1px 14px rgba(57,230,166,.08)}.public-header-tools{gap:8px}.public-header-social{width:35px;height:35px;border-radius:10px}.public-portal{min-height:38px;padding:0 14px;border-radius:11px;box-shadow:inset 0 1px 0 rgba(255,255,255,.07),0 8px 22px rgba(0,0,0,.12)}.public-menu{gap:5px}.public-menu a,.public-menu-dropdown-toggle{position:relative;min-height:36px;border:1px solid transparent;transition:color .18s ease,background .18s ease,border-color .18s ease,box-shadow .18s ease}.public-menu a:hover,.public-menu a:focus-visible,.public-menu-dropdown-toggle:hover,.public-menu-dropdown-toggle:focus-visible,.public-menu-dropdown-toggle[aria-expanded=true]{border-color:rgba(87,230,255,.12);box-shadow:inset 0 1px 0 rgba(255,255,255,.035)}.public-menu a[aria-current=page],.public-menu-dropdown-toggle[aria-current=page]{border-color:rgba(87,230,255,.13);box-shadow:inset 0 -1px 0 rgba(87,230,255,.75),0 4px 16px rgba(87,230,255,.05)}
