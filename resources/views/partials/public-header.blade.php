...
.public-header-top{min-height:54px;display:flex;align-items:center;justify-content:space-between;gap:20px;border-bottom:1px solid rgba(86,210,238,.09)}
...
.public-brand img,.public-brand-fallback{width:36px;height:36px;flex:0 0 36px}.public-brand img{object-fit:contain;border-radius:9px}.public-brand-fallback{display:grid;place-items:center;border-radius:9px;color:#43d1f0;border:1px solid rgba(86,210,238,.15)}
...
.public-header-divider{width:2px;height:32px;margin:0 9px;background:linear-gradient(180deg,transparent,rgba(99,214,239,.48),transparent);border-radius:99px}
...
@media(max-width:720px){.public-shell{width:calc(100% - 24px)}.public-header-top{min-height:64px;border-bottom:0}.public-header-tools{display:none}.public-brand-name{font-size:15px}.public-brand img,.public-brand-fallback{width:40px;height:40px;flex-basis:40px}.public-menu-toggle{display:flex}.public-header-nav{display:none;position:absolute;top:64px;left:12px;right:12px;height:auto;min-height:auto;padding:8px;background:rgba(4,18,26,.98);border:1px solid rgba(86,210,238,.15);border-radius:14px;box-shadow:0 20px 55px rgba(0,0,0,.3)}.public-header-nav.is-open{display:flex}.public-menu{flex-direction:column;align-items:stretch;justify-content:flex-start;overflow:visible;white-space:normal}.public-menu a,.public-menu a:visited{justify-content:flex-start;min-height:44px;padding:10px 13px;font-size:15px}}
@media(max-width:400px){.public-brand-name{font-size:14px}.public-brand img,.public-brand-fallback{width:38px;height:38px;flex-basis:38px}}
</style>
