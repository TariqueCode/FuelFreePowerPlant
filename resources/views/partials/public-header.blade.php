...
.public-brand img,.public-brand-fallback{width:var(--public-header-logo-width,42px);height:var(--public-header-logo-width,42px);flex:0 0 var(--public-header-logo-width,42px)}.public-brand img{object-fit:contain;border-radius:8px}.public-brand-fallback{display:grid;place-items:center;border-radius:8px;color:#43d1f0;border:1px solid rgba(86,210,238,.15)}
