@php
    ...
    $publicNavPages = \Illuminate\Support\Facades\Cache::remember('public.company-navigation', 300, fn () => \App\Models\SiteContentItem::query()->where('type','company')->where('status','published')->where('show_in_navigation',true)->orderByRaw("CASE WHEN slug = 'about-us' THEN 0 ELSE 1 END")->orderByRaw('CASE WHEN navigation_order IS NULL THEN 1 ELSE 0 END')->orderBy('navigation_order')->orderByDesc('created_at')->get(['id','title','slug','navigation_parent_id']));
    $publicCompanyActive = request()->routeIs('site.about') || request()->routeIs('company.page');
    $publicNavTree = collect($publicNavPages)->groupBy(fn ($item) => $item->navigation_parent_id ?: 0);
    $publicMenuGroups = json_decode(\App\Models\SystemSetting::query()->where('key','navigation.menu_groups')->value('value') ?? '[]', true) ?: [];
...
.public-brand{display:flex;align-items:center;gap:var(--public-header-logo-gap,9px);min-width:0;flex:0 0 auto;color:#effcff!important;text-decoration:none!important}.public-brand:visited,.public-brand:hover,.public-brand:active{color:#effcff!important;text-decoration:none!important}
.public-brand img,.public-brand-fallback{width:var(--public-header-logo-width,42px);height:var(--public-header-logo-width,42px);flex:0 0 var(--public-header-logo-width,42px)}.public-brand img{object-fit:var(--public-header-logo-fit,contain);border-radius:var(--public-header-logo-radius,8px)}.public-brand-fallback{display:grid;place-items:center;border-radius:8px;color:#43d1f0;border:1px solid rgba(86,210,238,.15)}
...
.public-menu-dropdown-panel{position:absolute;top:100%;left:50%;min-width:220px;padding:8px;background:rgba(4,18,26,.98);border:1px solid rgba(86,210,238,.15);border-radius:12px;box-shadow:0 18px 48px rgba(0,0,0,.34);opacity:0;visibility:hidden;pointer-events:none;transform:translate(-50%, -6px);transition:opacity .16s,visibility .16s,transform .16s;z-index:120}.public-menu-dropdown:hover .public-menu-dropdown-panel,.public-menu-dropdown.is-open .public-menu-dropdown-panel{opacity:1;visibility:visible;pointer-events:auto;transform:translate(-50%,0)}.public-menu-dropdown-panel a,.public-menu-dropdown-panel a:visited{display:flex;width:100%;min-height:40px;justify-content:flex-start;padding:9px 12px;font-size:13px;border-radius:9px}.public-menu-group{padding:7px 12px 3px;font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;opacity:.65}.public-menu-dropdown-subpanel{display:block;padding-left:10px;border-left:1px solid rgba(86,210,238,.12)}.public-menu-dropdown-subpanel a{font-size:12px!important;min-height:36px!important}.public-menu-dropdown-panel a:hover,.public-menu-dropdown-panel a:active,.public-menu-dropdown-panel a:focus,.public-menu-dropdown-panel a:focus-visible{background:rgba(67,209,240,.08);outline:0!important;box-shadow:none!important;-webkit-tap-highlight-color:transparent}
.public-header-tools{display:flex;align-items:center;justify-content:flex-end;gap:7px;min-width:0;flex:0 0 auto}.public-header-socials{display:flex;align-items:center;justify-content:var(--public-header-social-justify,flex-end);gap:var(--public-header-social-gap,5px)}.public-header-social{--social-color:#51d8f0;--public-social-bg:rgba(67,209,240,.035);display:inline-flex;align-items:center;justify-content:center;width:34px;height:34px;border-radius:9px;color:#8faeb8!important;background:var(--public-social-bg);border:1px solid rgba(86,210,238,.11);text-decoration:none!important;transition:color .18s,background .18s,border-color .18s,transform .18s,box-shadow .18s}.public-header-social.public-header-social--outline{background:transparent}.public-header-social.public-header-social--plain{background:transparent;border-color:transparent}.public-header-social:hover,.public-header-social:focus-visible,.public-header-social.is-touched{color:var(--social-color)!important;background:color-mix(in srgb,var(--social-color) 10%,transparent);border-color:color-mix(in srgb,var(--social-color) 40%,transparent);box-shadow:0 0 18px color-mix(in srgb,var(--social-color) 18%,transparent);transform:translateY(-1px)}.public-header-social i{font-size:var(--public-header-social-size,13px)}.public-header-divider{width:1px;height:34px;background:linear-gradient(to bottom,transparent,rgba(86,210,238,.38),transparent);margin:0 4px}.public-portal{display:inline-flex;align-items:center;justify-content:center;gap:7px;min-height:36px;padding:0 12px;border:1px solid rgba(86,210,238,.18);border-radius:9px;background:rgba(67,209,240,.055);color:#c8e9ef!important;font-size:11px;font-weight:750;text-decoration:none!important;white-space:nowrap;transition:background .18s,border-color .18s,color .18s,transform .18s}.public-portal:hover{color:#fff!important;background:rgba(67,209,240,.11);border-color:rgba(86,210,238,.32);transform:translateY(-1px)}.public-portal i{color:#55d8f1;font-size:10px}.mobile-portal-separator,.mobile-menu-portal{display:none}
...
@media(max-width:720px){.public-shell{width:calc(100% - 20px)}.public-header-top{min-height:58px;border-bottom:0}.public-header-nav{display:none;position:absolute;top:58px;left:12px;right:12px;height:auto;min-height:auto;padding:8px;background:rgba(4,18,26,.98);border:1px solid rgba(86,210,238,.15);border-radius:var(--public-header-mobile-nav-radius,14px);padding:var(--public-header-mobile-nav-padding,8px);box-shadow:0 20px 55px rgba(0,0,0,.3)}.public-header-nav.is-open{display:flex}.public-header-tools{display:flex;gap:3px}.public-socials{max-width:30vw;gap:1px}.public-social{width:28px;height:28px;border-radius:7px}.public-social i{font-size:11px}.public-header-divider{height:34px;margin:0 5px}.public-portal{min-height:30px;padding:0 8px;border-radius:8px;font-size:10px;gap:5px}.public-brand-name{font-size:14px}.public-brand img,.public-brand-fallback{width:min(var(--public-header-logo-width,42px),34px);height:min(var(--public-header-logo-width,42px),34px);flex-basis:min(var(--public-header-logo-width,42px),34px)}.public-menu-toggle{display:flex;width:var(--public-header-mobile-menu-size,38px);height:var(--public-header-mobile-menu-size,38px);border-radius:10px}.public-menu{flex-direction:column;align-items:stretch;justify-content:flex-start;overflow:visible;white-space:normal}.public-menu a,.public-menu a:visited{justify-content:flex-start;min-height:44px;padding:10px 13px;font-size:15px}}
@media(max-width:400px){.public-brand-name{font-size:13px}.public-brand img,.public-brand-fallback{width:min(var(--public-header-logo-width,42px),32px);height:min(var(--public-header-logo-width,42px),32px);flex-basis:min(var(--public-header-logo-width,42px),32px)}.public-social{width:26px;height:26px}.public-portal span{display:none}.public-portal{width:auto;min-width:30px;padding:0 9px;justify-content:center;gap:6px}.public-portal span{display:inline-block}}
...
@php
    ...
    $headerLogoWidth = max(24, min(96, (int) ($globalLayout['header.logo_width'] ?? 42)));
    ...
    $headerLogoRadius = max(0, min(24, (int) ($globalLayout['header.logo_radius'] ?? 8)));
    $headerLogoFit = in_array(($globalLayout['header.logo_fit'] ?? 'contain'), ['contain','cover','fill'], true) ? $globalLayout['header.logo_fit'] : 'contain';
    $headerBrandNameVisible = ($globalLayout['header.brand_name_visible'] ?? '1') === '1';
    $headerSocialStyle = in_array(($globalLayout['header.social_style'] ?? 'soft'), ['soft','outline','plain'], true) ? $globalLayout['header.social_style'] : 'soft';
    $headerSocialAlignment = in_array(($globalLayout['header.social_alignment'] ?? 'right'), ['left','center','right'], true) ? $globalLayout['header.social_alignment'] : 'right';
    $headerMobileMenuSize = max(34, min(48, (int) ($globalLayout['header.mobile_menu_size'] ?? 38)));
    $headerMobileNavRadius = max(0, min(24, (int) ($globalLayout['header.mobile_nav_radius'] ?? 14)));
    $headerMobileNavPadding = max(0, min(20, (int) ($globalLayout['header.mobile_nav_padding'] ?? 8)));
@endphp
<header class="public-header @if(!$headerSticky) public-header--static @endif @if(!$headerMobileSticky) public-header--mobile-static @endif" style="--public-header-height:{{ $headerHeight }}px;--public-header-container:{{ $headerContainer }}px;--public-header-nav-gap:{{ $headerNavGap }}px;--public-header-nav-justify:{{ $headerAlignment === 'left' ? 'flex-start' : ($headerAlignment === 'right' ? 'flex-end' : 'center') }};--public-header-logo-width:{{ $headerLogoWidth }}px;--public-header-logo-gap:{{ $headerLogoGap }}px;--public-header-logo-radius:{{ $headerLogoRadius }}px;--public-header-logo-fit:{{ $headerLogoFit }}px;--public-header-social-size:{{ $headerSocialSize }}px;--public-header-social-gap:{{ $headerSocialGap }}px;--public-header-social-justify:{{ $headerSocialAlignment === "left" ? "flex-start" : ($headerSocialAlignment === "center" ? "center" : "flex-end") }};--public-header-mobile-menu-size:{{ $headerMobileMenuSize }}px;--public-header-mobile-nav-radius:{{ $headerMobileNavRadius }}px;--public-header-mobile-nav-padding:{{ $headerMobileNavPadding }}px;--public-header-mobile-height:{{ $headerMobileHeight }}px;--public-header-mobile-logo-width:{{ $headerMobileLogoWidth }}px;">
    <div class="public-shell">
        <div class="public-header-top">
            <a class="public-brand" href="{{ route('home') }}" aria-label="{{ $publicName }}">
                ...
                @if($headerBrandNameVisible)<span class="public-brand-name"><span class="public-brand-name-first">{{ $publicNameFirst }}</span>@if($publicNameRest) <span class="public-brand-name-rest">{{ $publicNameRest }}</span>@endif</span>
            </a>
                ...
                @if(($globalLayout['header.social_visible'] ?? '1') === '1' && $publicSocials)
                    <div class="public-header-socials @if(!$headerMobileSocialVisible) public-header-socials--desktop-only @endif" aria-label="Social media">
                        @foreach($publicSocials as $social)
                            <a class="public-header-social @if($headerSocialStyle !== "soft") public-header-social--{{ $headerSocialStyle }} @endif" style="--social-color:{{ $social['color'] }}" href="{{ $social['url'] }}" target="_blank" rel="noopener noreferrer" aria-label="{{ $social['label'] }}" title="{{ $social['label'] }}">
            ...
            <nav class="public-menu" aria-label="Primary navigation">
                ...
                <div class="public-menu-dropdown @if($publicCompanyActive) is-current @endif" data-company-menu>
                    ...
                    <div id="public-company-menu" class="public-menu-dropdown-panel">
                        @php
                            $renderNavChildren = function ($parentId) use (&$renderNavChildren, $publicNavTree, $publicMenuGroups) {
                                foreach (collect($publicMenuGroups)->where('parent_id', $parentId ?: null) as $group) {
                                    echo '<div class="public-menu-group">'.e($group['label'] ?? '').'</div>';
                                }
                                foreach ($publicNavTree->get($parentId, collect()) as $navPage) {
                                    $navUrl = $navPage->slug === 'about-us' ? route('site.about') : route('company.page',$navPage->slug);
                                    $children = $publicNavTree->get($navPage->id, collect());
                                    echo '<a href="'.e($navUrl).'">'.e($navPage->title).'</a>';
                                    if ($children->isNotEmpty()) {
                                        echo '<div class="public-menu-dropdown-subpanel">';
                                        $renderNavChildren($navPage->id);
                                        echo '</div>';
                                    }
                                }
                            };
