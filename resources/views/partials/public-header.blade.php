...
.public-menu a,.public-menu a:visited{display:inline-flex;align-items:center;justify-content:center;min-height:34px;padding:6px 10px;border-radius:8px;color:#92adb6!important;font-size:12px;line-height:1.15;font-weight:600;text-decoration:none!important;white-space:nowrap;flex:0 0 auto;transition:color .18s,background .18s}.public-menu a:hover,.public-menu a:active,.public-menu a:focus,.public-menu a:focus-visible{color:#effcff!important;background:rgba(67,209,240,.08);text-decoration:none!important;outline:none;box-shadow:none}.public-menu a[aria-current=page]{color:#8bf3ff!important;background:rgba(67,209,240,.07)}
.public-menu-dropdown{position:relative;display:flex;align-items:center;flex:0 0 auto}.public-menu-dropdown-toggle{display:inline-flex;align-items:center;justify-content:center;gap:6px;min-height:34px;padding:6px 10px;border:0;border-radius:8px;background:transparent;color:#92adb6;font:inherit;font-size:12px;line-height:1.15;font-weight:600;cursor:pointer;white-space:nowrap;transition:color .18s,background .18s}.public-menu-dropdown-toggle:hover,.public-menu-dropdown-toggle:focus-visible,.public-menu-dropdown-toggle[aria-expanded=true]{color:#effcff;background:rgba(67,209,240,.08);outline:none}.public-menu-dropdown-toggle[aria-current=page]{color:#8bf3ff;background:rgba(67,209,240,.07)}.public-menu-dropdown-chevron{width:8px;height:8px;border-right:1.5px solid currentColor;border-bottom:1.5px solid currentColor;transform:rotate(45deg) translateY(-2px);transition:transform .18s}.public-menu-dropdown-toggle[aria-expanded=true] .public-menu-dropdown-chevron{transform:rotate(225deg) translate(-1px,-1px)}
.public-menu-dropdown-panel{position:absolute;top:calc(100% + 1px);left:50%;min-width:220px;padding:8px;background:rgba(4,18,26,.98);border:1px solid rgba(86,210,238,.15);border-radius:12px;box-shadow:0 18px 48px rgba(0,0,0,.34);opacity:0;visibility:hidden;pointer-events:none;transform:translate(-50%, -6px);transition:opacity .16s,visibility .16s,transform .16s;z-index:120}.public-menu-dropdown:hover .public-menu-dropdown-panel,.public-menu-dropdown:focus-within .public-menu-dropdown-panel,.public-menu-dropdown.is-open .public-menu-dropdown-panel{opacity:1;visibility:visible;pointer-events:auto;transform:translate(-50%,0)}.public-menu-dropdown-panel a,.public-menu-dropdown-panel a:visited{display:flex;width:100%;min-height:40px;justify-content:flex-start;padding:9px 12px;font-size:13px;border-radius:9px}.public-menu-dropdown-panel a:hover,.public-menu-dropdown-panel a:active,.public-menu-dropdown-panel a:focus,.public-menu-dropdown-panel a:focus-visible{background:rgba(67,209,240,.08);outline:none;box-shadow:none}
...
@media(max-width:720px){
  ...
  .public-menu-dropdown:hover .public-menu-dropdown-panel,.public-menu-dropdown:focus-within .public-menu-dropdown-panel{opacity:1;visibility:visible;transform:none}
