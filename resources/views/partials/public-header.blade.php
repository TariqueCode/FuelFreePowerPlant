...
.public-brand-name{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-size:16px;line-height:1.2;font-weight:800;letter-spacing:.01em}.public-brand-name-first{color:var(--ff-cyan)}.public-brand-name-rest{color:var(--ff-text);margin-left:.3em}
