...
.public-header-top{min-height:58px;display:flex;align-items:center;gap:14px;border-bottom:1px solid rgba(86,210,238,.09)}
...
.public-header-nav{display:flex;align-items:center;flex:1 1 auto;min-width:0;height:100%}.public-menu{width:100%;display:flex;align-items:center;justify-content:center;gap:1px;min-width:0;overflow-x:auto;overflow-y:hidden;white-space:nowrap;scrollbar-width:none;-webkit-overflow-scrolling:touch}.public-menu::-webkit-scrollbar{display:none}
...
.public-header-tools{display:flex;align-items:center;justify-content:flex-end;gap:4px;min-width:0;flex:0 0 auto}.public-socials{display:flex;align-items:center;gap:2px;max-width:220px;overflow-x:auto;scrollbar-width:none;-webkit-overflow-scrolling:touch}.public-socials::-webkit-scrollbar{display:none}
...
.public-header-divider{width:2px;height:40px;margin:0 9px;background:linear-gradient(180deg,transparent,rgba(99,214,239,.65),transparent);border-radius:99px}
...
@media(max-width:1000px) and (min-width:721px){.public-shell{width:min(1180px,calc(100% - 24px))}.public-header-top{gap:8px}.public-brand-name{font-size:13px}.public-social{width:28px;height:28px}.public-header-divider{height:34px;margin:0 5px}.public-portal{font-size:10px;padding:0 9px}.public-menu{justify-content:flex-start}.public-menu a,.public-menu a:visited{font-size:10px;padding-left:6px;padding-right:6px}}
