            ...
            <nav class="public-menu" aria-label="Primary navigation">
                ...
                <div class="public-menu-dropdown @if($publicCompanyActive) is-current @endif" data-company-menu>
                    ...
                    <div id="public-company-menu" class="public-menu-dropdown-panel">
                        <a href="{{ route('site.about') }}" @if(request()->routeIs('site.about')) aria-current="page" @endif>About Us</a>
                        @foreach($publicNavPages as $navPage)
                            <a href="{{ route('company.page',$navPage->slug) }}" @if(request()->routeIs('company.page') && request()->route('slug') === $navPage->slug) aria-current="page" @endif>{{ $navPage->title }}</a>
                        @endforeach
                    </div>
                </div>
