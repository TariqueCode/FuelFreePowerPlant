...
.public-header-top{min-height:50px;display:flex;align-items:center;justify-content:space-between;gap:20px;border-bottom:1px solid rgba(86,210,238,.09)}
.public-brand{display:flex;align-items:center;gap:10px;min-width:0;flex:0 1 auto;color:#effcff!important;text-decoration:none!important}.public-brand:visited,.public-brand:hover,.public-brand:active{color:#effcff!important;text-decoration:none!important}
.public-brand img,.public-brand-fallback{width:34px;height:34px;flex:0 0 34px}.public-brand img{object-fit:contain;border-radius:9px}.public-brand-fallback{display:grid;place-items:center;border-radius:9px;color:#43d1f0;border:1px solid rgba(86,210,238,.15)}
.public-brand-name{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-size:15px;line-height:1.2;font-weight:800;letter-spacing:-.02em}
.public-header-tools{display:flex;align-items:center;justify-content:flex-end;gap:5px;min-width:0;flex:0 0 auto}.public-socials{display:flex;align-items:center;gap:2px;max-width:min(45vw,420px);overflow-x:auto;scrollbar-width:none;-webkit-overflow-scrolling:touch}.public-socials::-webkit-scrollbar{display:none}
.public-social{width:31px;height:31px;display:grid;place-items:center;border:1px solid transparent;border-radius:8px;color:#86a7b1!important;text-decoration:none!important;transition:color .18s,background .18s,border-color .18s,transform .18s}.public-social:hover{color:#8bf3ff!important;background:rgba(67,209,240,.08);border-color:rgba(86,210,238,.16);transform:translateY(-1px)}.public-social i{font-size:12px}
.public-header-divider{width:2px;height:38px;margin:0 10px;background:linear-gradient(180deg,transparent,rgba(99,214,239,.48),transparent);border-radius:99px}
.public-portal{display:inline-flex;align-items:center;gap:7px;min-height:32px;padding:0 11px;border:1px solid rgba(86,210,238,.18);border-radius:9px;background:rgba(67,209,240,.055);color:#c8e9ef!important;font-size:11px;font-weight:750;text-decoration:none!important;white-space:nowrap;transition:background .18s,border-color .18s,color .18s,transform .18s}.public-portal:hover{color:#fff!important;background:rgba(67,209,240,.11);border-color:rgba(86,210,238,.32);transform:translateY(-1px)}.public-portal i{color:#55d8f1;font-size:11px}
.public-header-nav{height:38px;display:flex;align-items:center}.public-menu{width:100%;display:flex;align-items:center;justify-content:center;gap:1px;min-width:0;overflow-x:auto;overflow-y:hidden;white-space:nowrap;scrollbar-width:none;-webkit-overflow-scrolling:touch}.public-menu::-webkit-scrollbar{display:none}
.public-menu a,.public-menu a:visited{display:inline-flex;align-items:center;justify-content:center;min-height:30px;padding:5px 10px;border-radius:7px;color:#92adb6!important;font-size:11px;line-height:1.15;font-weight:600;text-decoration:none!important;white-space:nowrap;flex:0 0 auto;transition:color .18s,background .18s}.public-menu a:hover,.public-menu a:active{color:#effcff!important;background:rgba(67,209,240,.08);text-decoration:none!important}.public-menu a[aria-current=page]{color:#8bf3ff!important;background:rgba(67,209,240,.07)}
...
@media(max-width:1000px) and (min-width:721px){.public-shell{width:min(1180px,calc(100% - 24px))}.public-header-top{gap:10px}.public-brand-name{font-size:13px}.public-social{width:28px;height:28px}.public-header-divider{height:28px;margin:0 5px}.public-portal{font-size:10px;padding:0 9px}.public-menu{justify-content:flex-start}.public-menu a,.public-menu a:visited{font-size:10px;padding-left:7px;padding-right:7px}}
@media(max-width:720px){.public-shell{width:calc(100% - 20px)}.public-header-top{min-height:58px;border-bottom:0}.public-header-tools{display:flex;gap:3px}.public-socials{max-width:30vw;gap:1px}.public-social{width:28px;height:28px;border-radius:7px}.public-social i{font-size:11px}.public-header-divider{height:34px;margin:0 5px}.public-portal{min-height:30px;padding:0 8px;border-radius:8px;font-size:10px;gap:5px}.public-brand-name{font-size:14px}.public-brand img,.public-brand-fallback{width:34px;height:34px;flex-basis:34px}.public-menu-toggle{display:flex;width:38px;height:38px;border-radius:10px}.public-header-nav{display:none;position:absolute;top:58px;left:12px;right:12px;height:auto;min-height:auto;padding:8px;background:rgba(4,18,26,.98);border:1px solid rgba(86,210,238,.15);border-radius:14px;box-shadow:0 20px 55px rgba(0,0,0,.3)}.public-header-nav.is-open{display:flex}.public-menu{flex-direction:column;align-items:stretch;justify-content:flex-start;overflow:visible;white-space:normal}.public-menu a,.public-menu a:visited{justify-content:flex-start;min-height:44px;padding:10px 13px;font-size:15px}}
