@php
    ...
    $publicSocials = \App\Models\SocialLink::active()->get(['label','url','icon']);
...
.public-header-tools{display:flex;align-items:center;justify-content:flex-end;gap:5px;min-width:0;flex:0 0 auto}.public-socials{display:flex;align-items:center;gap:2px}
