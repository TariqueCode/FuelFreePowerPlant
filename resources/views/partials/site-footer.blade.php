...
<footer class="site-footer">
  <div class="site-shell site-footer-grid">
    ...
    <div><strong>Resources</strong><a href="{{ route('resources.index') }}">Resources</a><a href="{{ route('sustainability') }}">Sustainability</a><a href="{{ route('gallery.index') }}">Gallery</a><a href="{{ route('contact') }}">Contact</a></div>
  </div>
