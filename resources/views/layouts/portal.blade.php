...
@media(max-width:700px){.app{display:block}.sidebar{display:block;position:fixed;left:0;top:0;bottom:0;width:min(86vw,320px);height:100dvh;z-index:1200;padding:16px 12px;transform:translateX(-105%);transition:transform .24s ease;box-shadow:24px 0 60px rgba(0,0,0,.45)}.sidebar.mobile-open{transform:translateX(0)}.mobile-drawer-backdrop{display:block;position:fixed;inset:0;background:rgba(0,8,14,.62);backdrop-filter:blur(3px);z-index:1100;opacity:0;pointer-events:none;transition:opacity .24s}.mobile-drawer-backdrop.open{opacity:1;pointer-events:auto}.main{padding-bottom:0}.topbar{height:70px;padding:0 14px;display:grid;grid-template-columns:42px minmax(0,1fr) 42px;align-items:center;gap:10px;justify-content:initial}.mobile-menu-toggle{width:42px;height:42px;display:grid;place-items:center;border:1px solid rgba(104,204,235,.18);border-radius:13px;background:rgba(67,194,229,.08);color:#9fd8e8;flex:0 0 42px}.topbar-brand{display:flex;flex:1;min-width:0}.topbar-brand img{width:38px;height:38px}.topbar-title{font-size:14px;font-weight:700}.content{padding:20px 14px}.mobile-nav-wrap{display:none!important}.mobile-nav{display:none!important}.mobile-arrow{display:none!important}.mobile-scroll-hint{display:none}}
</style>
<style>
