...
<head>
    ...
    @endif
    <style>
         :root{--public-max:1180px;--public-gutter:16px;--public-bg:#020a10;--public-surface:{{ $theme['surface'] }};--public-line:rgba(96,216,239,.16);--public-text:{{ $theme['text'] }};--public-muted:{{ $theme['muted'] }};--public-accent:{{ $theme['primary'] }};--public-radius:{{ (int)$theme['radius'] }}px;--public-base-size:{{ (int)$theme['base_size'] }}px;--public-line-height:{{ $theme['line_height'] }};--public-space-section:{{ (int)$theme['space_section'] }}px;--public-space-content:{{ (int)$theme['space_content'] }}px;--public-font-body:{{ $theme['font_body'] }};--public-font-heading:{{ $theme['font_heading'] }};--public-space-1:4px;--public-space-2:8px;--public-space-3:12px;--public-space-4:16px;--public-space-5:24px;--public-space-6:32px;--public-space-7:48px;--public-space-8:64px}
