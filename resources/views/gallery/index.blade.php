...
@media(max-width:900px){.gallery-page{width:min(100% - 24px,700px);padding:40px 0 70px}.gallery-hero{display:block}.view-switch{display:none}.gallery-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.gallery-cover{aspect-ratio:1/1}.gallery-info{padding:13px}.gallery-title{font-size:13px}.gallery-meta{font-size:8px;margin-top:9px}.gallery-list .gallery-card{grid-template-columns:120px minmax(0,1fr);min-height:120px}.gallery-list .gallery-cover{width:120px;height:120px}}
@media(max-width:520px){.gallery-page{width:calc(100% - 24px);padding:32px 0 60px}.gallery-hero{padding-bottom:20px;margin-bottom:20px}.gallery-hero h1{font-size:43px}.gallery-hero p{font-size:12px}.gallery-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.gallery-card{border-radius:14px}.gallery-info{padding:10px}.gallery-title{font-size:12px}.gallery-meta{font-size:7px;gap:7px}.gallery-meta span{gap:4px}.gallery-list .gallery-card{grid-template-columns:100px 1fr;min-height:100px}.gallery-list .gallery-cover{width:100px;height:100px}.gallery-list .gallery-info{padding:12px}.gallery-list .gallery-title{font-size:14px}}
</style>
