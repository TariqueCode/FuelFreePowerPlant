...
<div class="management-actions">
    ...
    <div class="profile-count"><strong>{{ $members->count() }}</strong><span> profiles</span></div>
</div>
...
<article class="member" draggable="true" data-id="{{ $member->id }}" data-edit-url="{{ route('admin.management.edit',$member) }}">
    ...
    <div class="actions"><form method="POST" action="{{ route('admin.management.toggle',$member) }}">@csrf @method('PATCH')<button title="{{ $member->status==='published'?'Deactivate':'Activate' }}" aria-label="{{ $member->status==='published'?'Deactivate':'Activate' }}"><i class="fa-solid {{ $member->status==='published'?'fa-toggle-on':'fa-toggle-off' }}"></i></button></form><form method="POST" action="{{ route('admin.management.destroy',$member) }}" onsubmit="return confirm('Delete this management profile?')">@csrf @method('DELETE')<button title="Delete" aria-label="Delete"><i class="fa-solid fa-trash"></i></button></form></div>
</article>
@empty
