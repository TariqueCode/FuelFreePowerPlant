...
.highlight-media{display:block;width:170px;height:170px;overflow:hidden;background:#061923;aspect-ratio:1/1;flex:0 0 170px}
...
@media(max-width:600px){.highlight-hero{margin-bottom:12px}.highlight-header-actions{margin-bottom:10px;gap:8px;grid-template-columns:minmax(0,1fr) auto}.highlight-header-actions .primary{width:auto;min-width:0}.highlight-list{gap:10px}.highlight-card{grid-template-columns:104px minmax(0,1fr) 74px;min-height:104px;border-radius:14px}.highlight-media{width:104px;height:104px;min-width:104px;min-height:104px;aspect-ratio:1/1;align-self:start}.highlight-content{padding:11px 10px}.highlight-content h2{font-size:14px;margin:7px 0 6px;-webkit-line-clamp:2}.status,.link-type{font-size:7px}.status{padding:4px 6px}.meta-row{font-size:8px;gap:4px}.highlight-actions{padding:6px;gap:5px}.toggle-btn,.delete-btn{width:32px;height:32px;border-radius:9px}.toggle-track{width:18px;height:11px}.toggle-knob{width:7px;height:7px;top:2px;left:2px}.toggle-btn.active .toggle-knob{left:9px}.delete-btn{font-size:12px}.highlight-header-actions .profile-count{min-height:44px;padding:0 13px}.highlight-header-actions .profile-count strong{font-size:15px}.highlight-header-actions .profile-count span{font-size:10px}.empty-state{padding:13px 14px;border-radius:14px;gap:11px}.empty-icon{width:36px;height:36px;flex-basis:36px;border-radius:10px;font-size:15px}.empty-copy strong{font-size:12px}.empty-copy span{font-size:8px}}
@media(max-width:380px){.highlight-header-actions{gap:6px}.highlight-header-actions .profile-count{min-width:84px;padding:0 10px}.highlight-card{grid-template-columns:96px minmax(0,1fr) 68px;min-height:96px}.highlight-media{width:96px;height:96px;min-height:96px}.highlight-content{padding:10px 8px}.highlight-content h2{font-size:13px}.meta-row{font-size:7px}.toggle-btn,.delete-btn{width:30px;height:30px}.toggle-track{width:17px;height:10px}.toggle-knob{width:6px;height:6px}.toggle-btn.active .toggle-knob{left:9px}}
</style>
@endpush