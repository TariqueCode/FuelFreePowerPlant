...
/* Global image rules can set natural height; these explicit rules keep every highlight thumbnail truly square. */
.highlight-media{display:block;width:190px!important;height:190px!important;min-width:190px;min-height:190px;max-width:190px;max-height:190px;overflow:hidden;background:#061923;aspect-ratio:1/1;flex:0 0 190px}
.highlight-media img{display:block!important;width:100%!important;height:100%!important;min-width:100%;min-height:100%;max-width:none!important;max-height:none!important;aspect-ratio:1/1;object-fit:cover!important;object-position:center center!important}
.highlight-content{padding:20px 22px;min-width:0;color:inherit;text-decoration:none;display:flex;flex-direction:column;justify-content:center;overflow:hidden}
.highlight-top{display:flex;align-items:center;gap:8px;min-height:22px;min-width:0;flex-wrap:wrap}
.status,.link-type{display:inline-flex;align-items:center;gap:6px;font-size:8px;font-weight:800;letter-spacing:.06em;text-transform:uppercase;max-width:100%}
.status{padding:6px 10px;border-radius:999px}.status i{width:5px;height:5px;border-radius:50%;background:currentColor}.status.live{color:#8de8cc;background:rgba(67,194,137,.1)}.status.scheduled{color:#8bd9ff;background:rgba(67,176,229,.1)}.status.draft{color:#ffc77d;background:rgba(255,183,77,.1)}.status.expired{color:#ff9eaa;background:rgba(255,93,113,.1)}.link-type{color:#6f9aa5}
.highlight-content h2{font-size:20px;line-height:1.3;margin:11px 0 12px;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;overflow-wrap:anywhere}
...
@media(max-width:1180px){.highlight-hero{grid-template-columns:minmax(0,1fr);gap:14px}.highlight-header-actions{max-width:600px}.highlight-card{grid-template-columns:minmax(0,170px) minmax(0,1fr) 76px;min-height:170px}.highlight-media{width:170px!important;height:170px!important;min-width:170px;min-height:170px;max-width:170px;max-height:170px;flex-basis:170px}.highlight-content{padding:16px}.highlight-content h2{font-size:17px}.meta-row{font-size:9px}.highlight-actions{padding:8px}}
@media(max-width:900px){.highlight-header-actions{grid-template-columns:minmax(0,1fr) auto}.highlight-card{grid-template-columns:minmax(0,150px) minmax(0,1fr) 70px;min-height:150px}.highlight-media{width:150px!important;height:150px!important;min-width:150px;min-height:150px;max-width:150px;max-height:150px;flex-basis:150px}.highlight-content{padding:13px}.highlight-content h2{font-size:15px}.meta-row{flex-direction:column;gap:6px}}
@media(max-width:600px){.highlight-hero{margin-bottom:14px!important;gap:12px}.highlight-hero .eyebrow{font-size:10px}.highlight-hero h1{font-size:32px}.highlight-hero p{font-size:14px;line-height:1.5;margin-top:9px}.highlight-header-actions{gap:8px;grid-template-columns:minmax(0,1fr) auto}.highlight-header-actions .primary{min-height:44px;font-size:12px}.highlight-header-actions .profile-count{min-width:92px;min-height:44px;padding:0 12px;font-size:10px}.highlight-header-actions .profile-count strong{font-size:15px}.highlight-list{gap:10px}.highlight-card{grid-template-columns:minmax(0,104px) minmax(0,1fr) 74px;min-height:104px;border-radius:14px}.highlight-media{width:104px!important;height:104px!important;min-width:104px;min-height:104px;max-width:104px;max-height:104px;flex-basis:104px}.highlight-content{padding:11px 10px}.highlight-content h2{font-size:14px;margin:7px 0 6px}.status,.link-type{font-size:7px}.status{padding:4px 6px}.meta-row{font-size:8px;gap:4px}.highlight-actions{padding:6px;gap:5px}.toggle-btn,.delete-btn{width:32px;height:32px;border-radius:9px}.toggle-track{width:18px;height:11px}.toggle-knob{width:7px;height:7px;top:2px;left:2px}.toggle-btn.active .toggle-knob{left:9px}.delete-btn{font-size:12px}.empty-state{padding:13px 14px;border-radius:14px;gap:11px}.empty-icon{width:36px;height:36px;flex-basis:36px;border-radius:10px;font-size:15px}.empty-copy strong{font-size:12px}.empty-copy span{font-size:8px}}
@media(max-width:380px){.highlight-header-actions{gap:6px}.highlight-header-actions .profile-count{min-width:84px;padding:0 10px}.highlight-card{grid-template-columns:minmax(0,96px) minmax(0,1fr) 68px;min-height:96px}.highlight-media{width:96px!important;height:96px!important;min-width:96px;min-height:96px;max-width:96px;max-height:96px;flex-basis:96px}.highlight-content{padding:10px 8px}.highlight-content h2{font-size:13px}.meta-row{font-size:7px}.toggle-btn,.delete-btn{width:30px;height:30px}.toggle-track{width:17px;height:10px}.toggle-knob{width:6px;height:6px}.toggle-btn.active .toggle-knob{left:9px}}
</style>
@endpush