...
.highlight-header-actions{display:flex;align-items:center;gap:10px;margin-top:14px}
.highlight-published{min-height:46px;padding:0 16px;display:flex;align-items:center;justify-content:center;gap:7px;border:1px solid var(--line);border-radius:12px;background:rgba(8,37,50,.62);white-space:nowrap}.highlight-published strong{font-size:16px;color:var(--text)}.highlight-published span{font-size:11px;color:#7898a2}
