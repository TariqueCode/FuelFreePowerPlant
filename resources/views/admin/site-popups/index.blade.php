...
.highlight-header-actions{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:10px;align-items:stretch;margin-top:14px}
.highlight-published{display:flex;align-items:center;justify-content:center;gap:5px;min-width:100px;padding:0 15px;border:1px solid var(--line);border-radius:14px;background:rgba(67,194,229,.035);color:#7f9ba5;font-size:10px;white-space:nowrap}.highlight-published strong{font-size:16px;color:#eaf8fb}.highlight-published span{font-size:10px}
.highlight-create{display:inline-flex!important;align-items:center;justify-content:center;gap:8px;border:0!important;border-radius:11px!important;padding:11px 15px!important;background:linear-gradient(135deg,#25abc9,#1687a4)!important;color:#fff!important;text-decoration:none!important;font-size:10px!important;font-weight:800!important;white-space:nowrap;box-shadow:0 8px 24px rgba(16,137,165,.18);transition:transform .18s ease,box-shadow .18s ease,filter .18s ease}
...
.highlight-card{position:relative;display:grid;grid-template-columns:170px minmax(0,1fr) 92px;min-height:170px;overflow:hidden;border:1px solid var(--line);border-radius:18px;background:linear-gradient(145deg,rgba(8,37,50,.9),rgba(3,19,27,.94));transition:transform .2s,border-color .2s}
.highlight-card:hover{transform:translateY(-2px);border-color:rgba(72,216,241,.38)}
.highlight-media{display:block;width:170px;height:170px;overflow:hidden;background:#061923}
...
@media(max-width:600px){.highlight-hero{margin-bottom:12px}.highlight-header-actions{margin-top:12px;gap:8px;grid-template-columns:minmax(0,1fr) auto}.highlight-create{width:auto;min-width:0;padding:11px 12px!important;font-size:10px!important;border-radius:11px!important}.highlight-list{gap:10px}.highlight-card{grid-template-columns:104px minmax(0,1fr) 74px;min-height:104px;border-radius:14px}.highlight-media{width:104px;height:104px;min-height:104px;align-self:start}.highlight-content{padding:11px 10px}.highlight-content h2{font-size:14px;margin:7px 0 6px;-webkit-line-clamp:2}.status,.link-type{font-size:7px}.status{padding:4px 6px}.meta-row{font-size:8px;gap:4px}.highlight-actions{padding:6px;gap:5px}.toggle-btn,.delete-btn{width:32px;height:32px;border-radius:9px}.toggle-track{width:18px;height:11px}.toggle-knob{width:7px;height:7px;top:2px;left:2px}.toggle-btn.active .toggle-knob{left:9px}.delete-btn{font-size:12px}.highlight-published{min-height:44px;padding:0 13px}.highlight-published strong{font-size:15px}.highlight-published span{font-size:10px}.empty-state{padding:13px 14px;border-radius:14px;gap:11px}.empty-icon{width:36px;height:36px;flex-basis:36px;border-radius:10px;font-size:15px}.empty-copy strong{font-size:12px}.empty-copy span{font-size:8px}}
@media(max-width:380px){.highlight-header-actions{gap:6px}.highlight-published{min-width:84px;padding:0 10px}.highlight-card{grid-template-columns:96px minmax(0,1fr) 68px;min-height:96px}.highlight-media{width:96px;height:96px;min-height:96px}.highlight-content{padding:10px 8px}.highlight-content h2{font-size:13px}.meta-row{font-size:7px}.toggle-btn,.delete-btn{width:30px;height:30px}.toggle-track{width:17px;height:10px}.toggle-knob{width:6px;height:6px}.toggle-btn.active .toggle-knob{left:9px}}
</style>
@endpush