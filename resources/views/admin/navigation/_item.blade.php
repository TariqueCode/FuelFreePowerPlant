<div class="menu-row" draggable="true" data-id="{{ $item->id }}" data-kind="{{ $item->source_type }}" aria-grabbed="false">
    <div class="menu-card">
        ...
        <div class="menu-card-meta">
            ...
            <span class="type-pill">{{ $isManagementFolder ? 'Profile folder' : ($item->source_type === 'folder' ? 'Folder' : ($item->source_type === 'external_link' ? 'Custom link' : 'Live source')) }}</span>
    ...
    @elseif($item->source_type === 'folder')
