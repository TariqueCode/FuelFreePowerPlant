...
.slider-list{display:grid;grid-template-columns:1fr;gap:14px}.slider-card{position:relative;display:grid;grid-template-columns:32px 220px minmax(0,1fr) 74px;min-height:190px;overflow:hidden;border:1px solid var(--line);border-radius:18px;background:linear-gradient(145deg,rgba(8,37,50,.9),rgba(3,19,27,.94));transition:transform .2s,border-color .2s,box-shadow .2s}.slider-card:hover{transform:translateY(-2px);border-color:rgba(72,216,241,.38);box-shadow:0 10px 28px rgba(0,0,0,.18)}.slider-card.dragging{opacity:.55;transform:scale(.985)}.slider-card.drag-over{border-color:rgba(72,216,241,.7);box-shadow:0 0 0 2px rgba(72,216,241,.12)}.drag-handle{display:grid;place-items:center;color:#668994;cursor:grab;background:rgba(72,216,241,.025);border-right:1px solid rgba(116,221,239,.08);touch-action:none}.drag-handle:active{cursor:grabbing}.slider-media{display:block;width:220px;height:190px;overflow:hidden;background:#061923}.slider-media img{width:100%;height:100%;display:block;object-fit:cover}.slider-content{padding:20px 22px;min-width:0;color:inherit;text-decoration:none;display:flex;flex-direction:column;justify-content:center}.slider-top{display:flex;align-items:center;justify-content:space-between;gap:8px}.status{display:inline-flex;align-items:center;gap:6px;padding:6px 10px;border-radius:999px;font-size:8px;font-weight:800;letter-spacing:.06em;text-transform:uppercase}.status i{width:5px;height:5px;border-radius:50%;background:currentColor}.status.live{color:#8de8cc;background:rgba(67,194,137,.1)}.status.scheduled{color:#8bd9ff;background:rgba(67,176,229,.1)}.status.draft{color:#ffc77d;background:rgba(255,183,77,.1)}.status.expired{color:#ff9eaa;background:rgba(255,93,113,.1)}.slider-content h2{font-size:20px;line-height:1.3;margin:11px 0 12px;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.meta-row{display:flex;flex-wrap:wrap;gap:10px 20px;color:#7898a2;font-size:10px;line-height:1.45}.meta-row span{display:flex;align-items:flex-start;gap:6px}.meta-row i{color:#58cfe7;width:11px;margin-top:1px}.slider-actions{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:10px;border-left:1px solid rgba(116,221,239,.1);padding:10px}.slider-actions form{margin:0}.toggle-btn,.delete-btn{width:40px;height:40px;border:1px solid;cursor:pointer;display:grid;place-items:center;border-radius:11px}.toggle-btn{padding:0;background:rgba(72,216,241,.06);border-color:rgba(72,216,241,.18)}.toggle-btn.active{background:rgba(67,194,137,.08);border-color:rgba(67,194,137,.24)}.toggle-btn.inactive{opacity:.7}.toggle-track{position:relative;width:24px;height:14px;border-radius:999px;background:#405962;display:block}.toggle-knob{position:absolute;top:2px;left:2px;width:10px;height:10px;border-radius:50%;background:#b3c4c8;transition:left .18s ease}.toggle-btn.active .toggle-track{background:#32b985}.toggle-btn.active .toggle-knob{left:12px;background:#effff8}.delete-btn{padding:0;background:rgba(255,93,113,.045);border-color:rgba(255,93,113,.14);color:#ff9eaa;font-size:13px}.save-status{min-height:0;margin:0 0 10px;color:#73dcbf;font-size:9px;text-align:right}.save-status:empty{display:none}.empty-state{grid-column:1/-1;display:flex;align-items:center;gap:14px;padding:18px 20px;border:1px solid var(--line);border-radius:16px;background:rgba(8,37,50,.38);color:#7898a2}.empty-icon{width:42px;height:42px;flex:0 0 42px;display:grid;place-items:center;border-radius:12px;background:rgba(72,216,241,.08);color:#58cfe7;font-size:18px}.empty-copy{display:flex;flex-direction:column;gap:3px}.empty-copy strong{color:var(--text);font-size:14px}.empty-copy span{font-size:9px;line-height:1.45}
@media(max-width:1100px){.slider-card{grid-template-columns:30px 180px minmax(0,1fr) 68px;min-height:170px}.slider-media{width:180px;height:170px}.slider-content{padding:16px}.slider-content h2{font-size:17px}.meta-row{font-size:9px}}
@media(max-width:800px){.slider-card{grid-template-columns:28px 150px minmax(0,1fr) 62px;min-height:150px}.slider-media{width:150px;height:150px}.slider-content{padding:13px}.slider-content h2{font-size:15px}.meta-row{display:flex;flex-direction:column;gap:6px}.slider-actions{padding:7px}}
@media(max-width:600px){.slider-card{grid-template-columns:26px 92px minmax(0,1fr) 58px;min-height:92px;border-radius:14px}.slider-media{width:92px;height:92px}.slider-content{padding:9px}.slider-content h2{font-size:13px;margin:6px 0 5px}.meta-row{font-size:8px;gap:4px}.slider-actions{padding:5px}.drag-handle{font-size:11px}.slider-header-actions .profile-count{min-height:44px;padding:0 12px}}
</style>
@endpush
@push('scripts')
<script>
