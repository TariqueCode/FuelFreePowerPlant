...
<select id="block-format" class="toolbar-select format-select" title="Text style"><option value="p">Paragraph</option><option value="h1">Heading 1</option><option value="h2">Heading 2</option><option value="h3">Heading 3</option><option value="h4">Heading 4</option><option value="h5">Heading 5</option><option value="h6">Heading 6</option><option value="blockquote">Quote</option></select>
<select id="font-size" class="toolbar-select size-select" title="Font size"><option value="">Size</option><option value="2">Small</option><option value="3">Normal</option><option value="4">Large</option><option value="5">XL</option><option value="6">XXL</option></select>
...
/* CMS editor UI: same compact interaction model as Webmail, dark palette preserved. */
.editor-shell{width:100%;max-width:100%;min-width:0;position:relative;overflow:visible;box-sizing:border-box}
.editor-toolbar{position:sticky!important;top:70px!important;z-index:90!important;display:flex;align-items:center;gap:4px;flex-wrap:nowrap!important;width:100%;max-width:100%;min-width:0;overflow-x:auto;overflow-y:visible;white-space:nowrap;padding:8px!important;background:#0b202b!important;border-bottom:1px solid rgba(104,204,235,.14)!important;box-shadow:0 5px 16px rgba(0,0,0,.28)!important;scrollbar-width:thin;-webkit-overflow-scrolling:touch}
.editor-toolbar::-webkit-scrollbar{height:4px}.editor-toolbar::-webkit-scrollbar-thumb{background:rgba(104,204,235,.28);border-radius:99px}
...
.editor-toolbar button{min-width:34px!important;padding:0 8px!important;display:inline-flex;align-items:center;justify-content:center;cursor:pointer}
...
.editor-toolbar .format-select{width:122px!important}.editor-toolbar .size-select{width:72px!important}
.editor-toolbar .toolbar-color{width:38px!important;padding:0!important;display:inline-flex!important;align-items:center;justify-content:center;position:relative;cursor:pointer}
.editor-toolbar .toolbar-color i{font-size:12px;pointer-events:none}
.editor-toolbar .toolbar-color input{position:absolute;inset:0;width:100%;height:100%;opacity:0;cursor:pointer}
...
.editor-toolbar .tool-dropdown{position:relative;display:inline-flex;flex:0 0 auto}
.editor-toolbar .tool-dropdown-toggle{min-width:34px!important}
...
.editor>*{max-width:100%;box-sizing:border-box}.editor table{max-width:100%}.editor img,.editor video,.editor iframe{max-width:100%;height:auto;box-sizing:border-box}.editor iframe{min-width:0}.editor .content-columns{max-width:100%;min-width:0}.editor .content-column{min-width:0;overflow-wrap:anywhere}
@media(max-width:900px){.editor-toolbar{top:70px!important;padding:7px!important;gap:3px!important}.editor-toolbar button{min-width:36px!important}.editor-toolbar .format-select{width:116px!important}.editor-toolbar .size-select{width:70px!important}}
@media(max-width:650px){.editor-toolbar{top:70px!important;border-radius:10px!important;overflow-x:auto!important;overflow-y:visible!important}.editor-toolbar .tool-dropdown{flex:0 0 auto}.editor-toolbar .tool-dropdown-toggle{min-width:36px!important}.editor-toolbar .tool-menu{position:fixed;left:8px;right:8px;top:112px;max-height:min(52vh,420px);overflow:auto;z-index:10000}.editor-toolbar .tool-menu>button{min-height:42px;height:auto}.editor{font-size:16px;line-height:1.75;padding:14px}.editor h1{font-size:28px}.editor h2{font-size:23px}.editor h3{font-size:19px}.editor table{display:block;width:100%;overflow-x:auto}.editor>*{max-width:100%}}
@media(max-width:420px){.editor-toolbar{padding:6px!important;gap:3px!important}.editor-toolbar button{min-width:34px!important;height:33px!important}.editor-toolbar .toolbar-select{height:33px!important;font-size:10px!important}.editor-toolbar .format-select{width:106px!important}.editor-toolbar .size-select{width:66px!important}.editor-toolbar .toolbar-color{width:35px!important;height:33px!important}.editor{min-height:240px;padding:12px}}
</style>@endpush
