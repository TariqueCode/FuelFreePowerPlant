...
<header class="ne-header">
    ...
    <div class="ne-actions"><a class="ne-btn ne-btn-ghost" href="{{ route('admin.news_and_event') }}"><i class="fa-solid fa-arrow-left"></i> Back</a><button class="ne-btn ne-btn-primary" type="submit" form="news-event-form"><i class="fa-solid fa-floppy-disk"></i> Save</button></div>
</header>
...
<div class="ne-grid">
    ...
    <main class="ne-main">
        ...
        <section class="ne-card ne-editor-card">
            <div class="ne-card-head"><div><span>CANONICAL EDITOR</span><h2>Global CMS Editor</h2><p>Rich text, media, embeds, tables, CTA buttons, columns, HTML source and preview.</p></div></div>
...
/* FuelFree PowerPlant — NEWS EVENT PREMIUM RESPONSIVE 2D */
.ne-wrap{max-width:1500px!important;margin:0 auto!important;color:#eaf8fb}
.ne-grid{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;grid-template-areas:"editor editor editor" "identity seo publish" "media media media"!important;gap:16px!important;align-items:start!important}
.ne-sidebar,.ne-main{display:contents!important}
.ne-editor-card{grid-area:editor!important;min-width:0!important;width:100%!important;padding:0!important;overflow:visible!important}
.ne-identity{grid-area:identity!important;min-width:0!important}
.ne-sidebar>.ne-card:nth-child(2){grid-area:publish!important;min-width:0!important}
.ne-sidebar>.ne-card:nth-child(3){grid-area:seo!important;min-width:0!important}
.ne-media-card{grid-area:media!important;min-width:0!important}
.ne-card{border:1px solid rgba(103,208,234,.14)!important;border-radius:14px!important;background:#081d28!important;box-shadow:0 5px 16px rgba(0,0,0,.12)!important}
...
.ne-media-card .ne-thumb{grid-column:1!important;grid-row:2/5!important;width:220px!important;height:150px!important;aspect-ratio:auto!important;border-radius:10px!important}
.ne-media-card .ne-upload{grid-column:2!important;grid-row:2!important;margin-top:0!important}
.ne-media-card>label:last-child{grid-column:2!important;grid-row:3!important;margin-top:10px!important}
.ne-media-card .ne-remove{grid-column:2!important;grid-row:4!important}
.ne-card input,.ne-card textarea,.ne-card select{border-radius:8px!important;background:#061923!important}
.ne-card input:focus,.ne-card textarea:focus,.ne-card select:focus{border-color:rgba(76,207,231,.55)!important;box-shadow:0 0 0 2px rgba(76,207,231,.07)!important}
@media(max-width:1100px){.ne-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important;grid-template-areas:"editor editor" "identity identity" "seo publish" "media media"!important}.ne-media-card{grid-template-columns:200px minmax(0,1fr)!important}.ne-media-card .ne-thumb{width:200px!important;height:140px!important}}
@media(max-width:700px){.ne-grid{grid-template-columns:1fr!important;grid-template-areas:"editor" "identity" "seo" "publish" "media"!important}.ne-header{align-items:stretch!important;flex-direction:column!important;gap:14px!important}.ne-actions{width:100%!important}.ne-media-card{grid-template-columns:1fr!important;grid-template-rows:auto!important}.ne-media-card .ne-card-head,.ne-media-card .ne-thumb,.ne-media-card .ne-upload,.ne-media-card .ne-remove,.ne-media-card>label:last-child{grid-column:1!important;grid-row:auto!important}.ne-media-card .ne-thumb{width:100%!important;height:210px!important}.ne-editor-card .ne-card-head{padding:14px!important}}
@media(max-width:420px){.ne-card{padding:13px!important;border-radius:12px!important}.ne-header h1{font-size:26px!important}.ne-actions{display:grid!important;grid-template-columns:1fr!important}.ne-actions>*{width:100%!important}.ne-media-card .ne-thumb{height:180px!important}}
</style>
@endpush
@push('scripts')
<script>
