...
<div class="pb-index">
    <header class="pbi-header">
        ...
        <a class="pbi-primary" href="{{ route('admin.cms.create') }}"><i class="fa-solid fa-plus"></i> New Page</a>
    </header>
            ...
            @foreach($pages as $page)
                ...
                <article class="pbi-card">
                    ...
                    <div class="pbi-actions">
                        ...
                        @if($isCms)<a href="{{ route('cms.page', $page->slug) }}" target="_blank" rel="noopener"><i class="fa-solid fa-arrow-up-right-from-square"></i>Preview</a>@endif
