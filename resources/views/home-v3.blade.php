...
.home-cta{padding:52px 0 76px}
.cta-box{border:1px solid var(--line);border-radius:24px;padding:34px;background:linear-gradient(145deg,rgba(8,37,50,.92),rgba(3,19,27,.96));box-shadow:0 22px 55px rgba(0,0,0,.16)}
.cta-box .eyebrow{display:block;margin-bottom:8px}
.cta-box h2{margin:0;max-width:820px;font-size:clamp(28px,4vw,46px);line-height:1.05;letter-spacing:-.04em}
.cta-box p{max-width:720px;color:var(--muted);font-size:14px;line-height:1.8;margin:15px 0 22px}
.cta-actions{display:flex;flex-wrap:wrap;gap:10px}
.cta-actions a{display:inline-flex;align-items:center;justify-content:center;min-height:42px;padding:0 17px;border-radius:10px;border:1px solid var(--line);color:var(--cyan);font-size:12px;font-weight:800}
.cta-actions a.primary{background:var(--cyan);border-color:var(--cyan);color:#031018}
@media(max-width:650px){.home-cta{padding:40px 0 56px}.cta-box{padding:24px 20px;border-radius:20px}.cta-actions{display:grid;grid-template-columns:1fr}.cta-actions a{width:100%}}
