...
*{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at 10% 0,rgba(33,187,221,.13),transparent 30%),linear-gradient(180deg,#020a10,#061721 55%,#020a10);color:var(--text);font-family:Inter,system-ui,-apple-system,"Segoe UI",sans-serif}a{text-decoration:none;color:inherit}.shell{width:min(var(--max),calc(100% - 32px));margin:auto}.welcome{padding:88px 0 72px;text-align:center;position:relative;isolation:isolate}.welcome:before,.welcome:after{content:'';position:absolute;border:1px solid rgba(72,216,241,.12);border-radius:50%;pointer-events:none;z-index:-1;animation:welcomeFloat 9s ease-in-out infinite}.welcome:before{width:260px;height:260px;right:-90px;top:8%;box-shadow:0 0 80px rgba(72,216,241,.08)}.welcome:after{width:150px;height:150px;left:-45px;bottom:6%;animation-delay:-3s}@keyframes welcomeFloat{0%,100%{transform:translate3d(0,0,0) rotate(0deg);opacity:.55}50%{transform:translate3d(0,-12px,0) rotate(8deg);opacity:.9}}.eyebrow{color:var(--cyan);font-size:12px!important;letter-spacing:.2em;text-transform:uppercase}.welcome h1{font-size:clamp(42px,7vw,82px);line-height:.98;letter-spacing:-.06em;margin:15px auto;max-width:900px}.welcome h1 em{font-style:normal;color:#a9f5ff}.welcome p{max-width:760px;margin:0 auto;color:var(--muted);font-size:16px!important;line-height:1.9;text-align:left}.welcome-message-title{display:block;color:var(--text);font-size:clamp(22px,3vw,30px);font-weight:750;line-height:1.2;margin:0 0 14px}.welcome-message-copy{display:block}.section{padding:58px 0;border-top:1px solid rgba(83,218,240,.08);animation:sectionReveal .7s ease both}.section-layout-center .head{text-align:center}.section-layout-center .head>div{margin-inline:auto}.section-layout-right .head{text-align:right}.section-layout-right .head>div{margin-left:auto}@keyframes sectionReveal{from{opacity:0;transform:translateY(12px)}to{opacity:1;transform:none}}@media(prefers-reduced-motion:reduce){.section,.welcome:before,.welcome:after{animation:none}}.head{display:flex;justify-content:space-between;align-items:end;gap:24px;margin-bottom:26px}.head h2{font-size:clamp(28px,4vw,45px);letter-spacing:-.04em;margin:5px 0}.more{font-size:13px!important;color:var(--cyan);white-space:nowrap}
