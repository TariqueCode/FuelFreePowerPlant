...
.news-grid{grid-template-columns:repeat(3,minmax(0,1fr));gap:20px}.news{display:block;min-height:0}.news-media{width:100%;height:205px;min-height:205px}.news-body{min-height:190px}.news h3{font-size:17px}.folders{grid-template-columns:repeat(4,minmax(0,1fr));gap:18px}.folder-media{aspect-ratio:4/3}.folder-body{padding:15px 16px 16px}.folder-body h3{font-size:15px}.folder-meta{margin-top:10px}
}
...
.home-slider{position:relative;width:100%;margin:28px 0 0;overflow:hidden;border:1px solid var(--line);border-radius:24px;background:#061923;box-shadow:0 28px 70px rgba(0,0,0,.22)}
.slider-track{position:relative;aspect-ratio:21/7;min-height:240px}
...
.slide-caption strong{font-size:clamp(20px,3vw,38px);line-height:1.1;letter-spacing:-.03em}
...
.welcome{padding:76px 0 78px}
.welcome-heading{padding-bottom:30px}
...
.slider-track{aspect-ratio:16/6;min-height:210px}
...
.home-slider{margin:8px 0 0;border-radius:18px}
