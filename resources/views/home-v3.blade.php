...
.home-v3 .home-section > .head{
 ...
 width:100%;margin-bottom:30px;text-align:left!important;
}
.home-v3 .home-section > .head>div{flex:1 1 auto;min-width:0;margin:0!important;text-align:left!important;}
.home-v3 .home-section > .head .eyebrow{display:block;width:max-content;max-width:100%;margin:0!important;font-size:10px;line-height:1.2;letter-spacing:.2em;text-transform:uppercase;}
.home-v3 .home-section > .head h2{margin:7px 0 0!important;font-size:clamp(30px,3.3vw,46px)!important;line-height:1.04;letter-spacing:-.045em;text-align:left!important;}
.home-v3 .home-section > .head>div:after{content:"";display:block;width:42px;height:2px;margin-top:11px;border-radius:999px;background:var(--cyan,#49d7ef);}
.home-v3 .home-section > .head>p{flex:0 1 420px;margin:0 0 3px!important;text-align:right;}
.home-v3 .home-section > .head>.more{flex:0 0 auto;align-self:flex-end;margin:0 0 4px!important;padding:0!important;border:0!important;background:transparent!important;white-space:nowrap;text-align:right;}
@media(max-width:850px){
