...
@media(max-width:820px){.career-layout{grid-template-columns:1fr}.career-hero{border-radius:22px}.career-card{border-radius:18px}}
@media(max-width:560px){.career-page{width:min(100% - 20px,1180px);padding-top:25px}.career-hero{padding:24px 20px}.career-hero h1{font-size:clamp(35px,12vw,54px)}.career-form-grid{grid-template-columns:1fr}.career-field.full{grid-column:auto}.career-card{padding:17px}.career-job-top{align-items:flex-start}.career-stats{gap:6px}.career-stat{font-size:8px}}
</style>
