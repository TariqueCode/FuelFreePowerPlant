...
<ul>
    ...
    <li>Effective average output: <strong>500 kW</strong></li>
    ...
    <li>Inflation: <strong>Not included</strong></li>
</ul>
...
HTML;
    ...
    public function down(): void
    {
        ...
        $marker = '<h2 id="normal">Normal Scenario</h2>';
        $start = strpos((string) $item->content, $marker);
        $end = strpos((string) $item->content, '<section id="conservative">');

        if ($start !== false && $end !== false && $end > $start) {
            $content = substr((string) $item->content, 0, $start)
                . '<h2 id="normal">Normal</h2>\n<p>Normal scenario content will be added in the next verified step.</p>\n\n'
                . substr((string) $item->content, $end);
