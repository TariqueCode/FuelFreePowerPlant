...
return new class extends Migration
{
    public function up(): void
    {
        DB::table('cms_pages')->updateOrInsert(
            ...
            [
                'title' => 'About Us',
                'excerpt' => 'Fuel Free Power Plant Limited is an innovative clean energy company committed to developing and promoting fuel-free, flywheel-based power generation and energy technology.',
                'content' => <<<'HTML'
...
<h2>Our Mission</h2>
<ul>
<li>Develop and commercialize fuel-free flywheel-based power technology.</li>
<li>Reduce dependence on diesel, gas and other conventional fuels for electricity generation.</li>
<li>Provide reliable and economically competitive electricity solutions for industries and businesses.</li>
<li>Promote clean and environmentally responsible energy generation.</li>
<li>Support Bangladesh's growing demand for reliable and affordable electricity.</li>
<li>Develop scalable power-generation systems suitable for both industrial and grid-connected applications.</li>
<li>Encourage research, innovation and engineering excellence in the clean energy sector.</li>
</ul>
