...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('role:super-admin,administrator')->prefix('admin')->group(function () {
        ...
        Route::middleware('permission:documents.view')->group(function () {
            ...
            Route::patch('/documents/folders/{folder}', [DocumentController::class, 'renameFolder'])->name('admin.documents.folders.rename');
            ...
            Route::patch('/documents/{document}', [DocumentController::class, 'rename'])->name('admin.documents.rename');
        ...
        Route::get('/email', [AdminModuleController::class, 'email'])->name('admin.email')->middleware('permission:email.view');
        Route::get('/support', [AdminModuleController::class, 'support'])->name('admin.support')->middleware('permission:support.view');
    });
