...
// Backward-compatible public route aliases used by the current homepage view.
Route::get('/management', ManagementController::class)->name('management.index');
Route::get('/gallery', [PublicSiteController::class, 'show'])->defaults('section', 'gallery')->name('gallery.index');
Route::get('/plants', [PublicSiteController::class, 'show'])->defaults('section', 'plants')->name('power-plants.index');
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->middleware('permission:email.view')->group(function () { Route::get('/email', [InfrastructureController::class, 'email'])->name('admin.email'); }); Route::prefix('admin')->middleware('permission:email.manage')->group(function () { Route::get('/email/create', [InfrastructureController::class, 'createEmail'])->name('admin.email.create'); Route::post('/email', [InfrastructureController::class, 'storeEmail'])->name('admin.email.store'); Route::delete('/email/{account}', [InfrastructureController::class, 'destroyEmail'])->name('admin.email.destroy'); });
    ...
    Route::get('/portal', ClientPortalController::class)->name('portal.dashboard')->middleware('role:client'); Route::post('/logout', [AuthController::class, 'logout'])->name('logout');
});
