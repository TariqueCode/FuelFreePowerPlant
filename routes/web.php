...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->middleware('permission:plants.view')->group(function () { Route::get('/plants/{plant}/performance', [PlantPerformanceController::class, 'index'])->name('admin.plants.performance.index'); });
    Route::prefix('admin')->middleware('permission:plants.manage')->group(function () { Route::post('/plants/{plant}/performance', [PlantPerformanceController::class, 'store'])->name('admin.plants.performance.store'); Route::delete('/plants/{plant}/performance/{performance}', [PlantPerformanceController::class, 'destroy'])->name('admin.plants.performance.destroy'); });
