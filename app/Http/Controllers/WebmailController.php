...
class WebmailController extends Controller
{
    ...
    public function inbox(Request $request, WebmailService $webmail): View|RedirectResponse
    {
        ...
        try {
            ...
            report($e);
            return $this->logout($request)->withErrors(['email' => 'Your mailbox connection has expired. Please sign in again.']);
        }
    ...
    private function credentials(Request $request): array
    {
        ...
        abort_unless($email && $encrypted, 302, '', ['Location' => route('webmail.login')]);
