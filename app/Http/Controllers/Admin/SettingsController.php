...
class SettingsController
{
    public function index(): View
    {
        $defaults=[
            ...
            'home.slider_enabled'=>'1','home.welcome_enabled'=>'1','home.news_enabled'=>'1','home.gallery_enabled'=>'1','home.cta_enabled'=>'1',
            'home.welcome_eyebrow'=>'Welcome to '.config('fuelfree.company.name'),'home.welcome_title'=>'Building a stronger energy future.','home.welcome_intro_1'=>'FuelFree PowerPlant is a forward-thinking energy company committed to contributing to Bangladesh’s sustainable energy future. Our vision is to develop efficient, reliable, and innovative power solutions that support the country’s growing energy needs and economic development.','home.welcome_intro_2'=>'We are dedicated to building a cleaner and smarter energy future through innovation, responsible development, and world-class management practices. We aim to strengthen our capabilities, expand our projects, embrace modern technologies, and deliver dependable energy solutions while maintaining our commitment to quality, sustainability, and excellence.','home.welcome_signoff'=>config('fuelfree.company.name').' — Powering a cleaner, smarter future.',
            'home.news_eyebrow'=>'Latest updates','home.news_title'=>'News & Notices','home.news_description'=>'','home.gallery_eyebrow'=>'Photo collections','home.gallery_title'=>'Gallery','home.gallery_description'=>'',
            'home.cta_eyebrow'=>'Let’s work together','home.cta_title'=>'Build the next chapter of clean energy.','home.cta_text'=>'Talk to our team about projects, partnerships, and reliable energy solutions.','home.cta_primary_label'=>'Get in touch','home.cta_primary_url'=>'/contact','home.cta_secondary_label'=>'Explore our projects','home.cta_secondary_url'=>'/power-plants',
        ];
    ...
    public function update(Request $request,WebmailService $webmail): RedirectResponse
    {
        $validated=$request->validate([
            ...
            'home.slider_enabled'=>['nullable','boolean'],'home.welcome_enabled'=>['nullable','boolean'],'home.news_enabled'=>['nullable','boolean'],'home.gallery_enabled'=>['nullable','boolean'],'home.cta_enabled'=>['nullable','boolean'],
            'home.welcome_eyebrow'=>['required','string','max:150'],'home.welcome_title'=>['required','string','max:255'],'home.welcome_intro_1'=>['required','string','max:2000'],'home.welcome_intro_2'=>['required','string','max:2000'],'home.welcome_signoff'=>['required','string','max:255'],
            'home.news_eyebrow'=>['required','string','max:150'],'home.news_title'=>['required','string','max:150'],'home.news_description'=>['nullable','string','max:500'],'home.gallery_eyebrow'=>['required','string','max:150'],'home.gallery_title'=>['required','string','max:150'],'home.gallery_description'=>['nullable','string','max:500'],
            'home.cta_eyebrow'=>['required','string','max:150'],'home.cta_title'=>['required','string','max:255'],'home.cta_text'=>['required','string','max:500'],'home.cta_primary_label'=>['required','string','max:100'],'home.cta_primary_url'=>['required','string','max:255'],'home.cta_secondary_label'=>['required','string','max:100'],'home.cta_secondary_url'=>['required','string','max:255'],
        ...
        $data=[
            ...
            'home.news_enabled'=>$request->boolean('home.news_enabled')?'1':'0','home.gallery_enabled'=>$request->boolean('home.gallery_enabled')?'1':'0','home.cta_enabled'=>$request->boolean('home.cta_enabled')?'1':'0',
            ...
            'home.news_eyebrow'=>data_get($validated,'home.news_eyebrow'),'home.news_title'=>data_get($validated,'home.news_title'),'home.news_description'=>data_get($validated,'home.news_description'),'home.gallery_eyebrow'=>data_get($validated,'home.gallery_eyebrow'),'home.gallery_title'=>data_get($validated,'home.gallery_title'),'home.gallery_description'=>data_get($validated,'home.gallery_description'),
            'home.cta_eyebrow'=>data_get($validated,'home.cta_eyebrow'),'home.cta_title'=>data_get($validated,'home.cta_title'),'home.cta_text'=>data_get($validated,'home.cta_text'),'home.cta_primary_label'=>data_get($validated,'home.cta_primary_label'),'home.cta_primary_url'=>data_get($validated,'home.cta_primary_url'),'home.cta_secondary_label'=>data_get($validated,'home.cta_secondary_label'),'home.cta_secondary_url'=>data_get($validated,'home.cta_secondary_url'),
