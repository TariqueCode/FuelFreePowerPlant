...
class SettingsController
{
    ...
    public function header(): View
    {
        $defaults = [
            ...
            'header.height'=>'64','header.container_width'=>'1280','header.nav_gap'=>'4','header.alignment'=>'center','header.sticky'=>'1','header.logo_width'=>'42','header.logo_gap'=>'9',
        ];
    ...
    public function updateHeader(Request $request): RedirectResponse
    {
        ...
        $data = $request->validate([
            ...
            'header.height'=>['required','integer','min:48','max:120'],'header.container_width'=>['required','integer','min:960','max:1600'],'header.nav_gap'=>['required','integer','min:0','max:24'],'header.alignment'=>['required','in:left,center,right'],'header.sticky'=>['nullable','boolean'],'header.logo_width'=>['required','integer','min:24','max:96'],'header.logo_gap'=>['required','integer','min:0','max:24'],
        ]);
        $system = collect($data)->except(['header.height','header.container_width','header.nav_gap','header.alignment','header.sticky','header.logo_width','header.logo_gap'])->all();
