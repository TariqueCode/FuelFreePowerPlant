...
class SettingsController
{
    ...
    public function header(): View
    {
        $defaults = [
            ...
            'header.height'=>'64','header.container_width'=>'1280','header.nav_gap'=>'4','header.alignment'=>'center','header.sticky'=>'1','header.logo_width'=>'42','header.logo_gap'=>'9','header.social_size'=>'13','header.social_gap'=>'5','header.mobile_height'=>'56','header.mobile_logo_width'=>'34','header.mobile_social_visible'=>'0','header.mobile_sticky'=>'1','header.logo_radius'=>'8','header.logo_fit'=>'contain','header.brand_name_visible'=>'1','header.social_style'=>'soft','header.social_alignment'=>'right','header.mobile_menu_size'=>'38','header.mobile_nav_radius'=>'14','header.mobile_nav_padding'=>'8',
        ];
    ...
    public function updateHeader(Request $request): RedirectResponse
    {
        ...
        $data = $request->validate([
            ...
            'header.height'=>['required','integer','min:48','max:120'],'header.container_width'=>['required','integer','min:960','max:1600'],'header.nav_gap'=>['required','integer','min:0','max:24'],'header.alignment'=>['required','in:left,center,right'],'header.sticky'=>['nullable','boolean'],'header.logo_width'=>['required','integer','min:24','max:96'],'header.logo_gap'=>['required','integer','min:0','max:24'],'header.social_size'=>['required','integer','min:12','max:28'],'header.social_gap'=>['required','integer','min:0','max:16'],'header.mobile_height'=>['required','integer','min:48','max:88'],'header.mobile_logo_width'=>['required','integer','min:24','max:48'],'header.mobile_social_visible'=>['nullable','boolean'],'header.mobile_sticky'=>['nullable','boolean'],'header.logo_radius'=>['required','integer','min:0','max:24'],'header.logo_fit'=>['required','in:contain,cover,fill'],'header.brand_name_visible'=>['nullable','boolean'],'header.social_style'=>['required','in:soft,outline,plain'],'header.social_alignment'=>['required','in:left,center,right'],'header.mobile_menu_size'=>['required','integer','min:34','max:48'],'header.mobile_nav_radius'=>['required','integer','min:0','max:24'],'header.mobile_nav_padding'=>['required','integer','min:0','max:20'],
        ]);
        foreach (['header.height','header.container_width','header.nav_gap','header.alignment','header.sticky','header.logo_width','header.logo_gap','header.social_size','header.social_gap','header.mobile_height','header.mobile_logo_width','header.mobile_social_visible','header.mobile_sticky','header.logo_radius','header.logo_fit','header.brand_name_visible','header.social_style','header.social_alignment','header.mobile_menu_size','header.mobile_nav_radius','header.mobile_nav_padding','header.home_label','header.management_label','header.gallery_label','header.news_label','header.career_label','header.contact_label','header.webmail_label','header.portal_label','header.login_label','header.logo_visible','header.social_visible','header.portal_visible'] as $key) {
