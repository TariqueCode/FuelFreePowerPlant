...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        Blade::precompiler(function (string $template): string {
            $routeMap=['admin.management.'=>'admin.profile-builder.','admin.cms.'=>'admin.page-builder.','admin.navigation.'=>'admin.menu-builder.'];
            $template=str_replace(array_keys($routeMap),array_values($routeMap),$template);
            return str_replace(['Advanced Menu Builder','Content Pages','Website Navigation','CONTENT MANAGEMENT','WEBSITE SECTIONS · MANAGEMENT','New CMS Page','Edit CMS Page','Add Management Member','Edit Management Profile','Add management member'],['Menu Builder','Page Builder','Menu Builder','PAGE BUILDER','GLOBAL · PROFILE BUILDER','New Page','Edit Page','Add Profile','Edit Profile','Add profile'],$template);
        });

        $this->app['router']->matched(function (RouteMatched $event): void {
            $routeName=$event->route->getName();
            if(in_array($routeName,['admin.navigation.index','admin.navigation.store','admin.navigation.reorder','admin.navigation.show','admin.navigation.update','admin.navigation.destroy','admin.management.index','admin.management.store','admin.management.create','admin.management.reorder','admin.management.update','admin.management.destroy','admin.management.edit','admin.management.toggle','admin.cms.index','admin.cms.store','admin.cms.create','admin.cms.update','admin.cms.destroy','admin.cms.duplicate','admin.cms.edit','admin.cms.toggle'],true)) abort(404);
        });
